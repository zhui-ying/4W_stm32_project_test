...
//蓝牙IO
#define BT_SET         GPIO_SetBits(GPIOB , GPIO_Pin_10)
#define BT_RESET       GPIO_ResetBits(GPIOB , GPIO_Pin_10)
#define BT_REC         GPIO_ReadInputDataBit(GPIOB, GPIO_Pin_11)
 ...
 */
#define FRONT_LEFT_F_PIN         GPIO_Pin_2
...
#define FRONT_LEFT_B_PIN         GPIO_Pin_0
...
#define FRONT_RIGHT_F_PIN         GPIO_Pin_3
#define FRONT_RIGHT_F_GPIO        GPIOF
...
#define FRONT_RIGHT_B_GPIO        GPIOF
...
#define BEHIND_LEFT_F_PIN         GPIO_Pin_0
...
#define BEHIND_RIGHT_F_PIN         GPIO_Pin_9
#define BEHIND_RIGHT_F_GPIO        GPIOF
...
#define BEHIND_RIGHT_B_GPIO        GPIOF
...
extern volatile unsigned char bt_rec_flag;//蓝牙控制标志位
